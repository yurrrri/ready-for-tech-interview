...
### ❗️ class의 성능을 향상 시킬수 있는 방법들을 나열해보시오.

- 이부분 method dispatch 복습하고 다시 정리
...
#### ❗️defer가 호출되는 순서는 어떻게 되고, defer가 호출되지 않는 경우를 설명하시오.
