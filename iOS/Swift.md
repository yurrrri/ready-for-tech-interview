...
- Extension 은 기존의 구조체나 클래스, 열거형에에 기능을 확장하기 위한 것이지 상속을 하는것이 아니기 때문에, 재정의가 불가능합니다.
- 
...
#### 8-1. Closure와 함수와의 관계에 대해 설명하시오.
#### 8-2. 탈출 Closure에 대해 설명하시오.
...
### 14. Hashable이 무엇이고, Equatable을 왜 상속해야 하는지 설명하시오.
...
### 15. struct와 class와 enum의 차이를 설명하시오.
### 16. class의 성능을 향상 시킬수 있는 방법들을 나열해보시오.
### 17. Copy On Write는 어떤 방식으로 동작하는지 설명하시오.
### 18. init(이니셜라이저)의 종류에 대해 이야기해주세요.

- 지정생성자, 편의 생성자, 필수 생성자, 실패가능 생성자가 있습니다.

#### 18-1. 지정 이니셜라이저(designated initializer)는 무엇인가요?

- init() 형태를 가지는 생성자로, 모든 저장 속성을 초기화하는 생성자입니다.

#### 18-2. convenience init(편의 생성자)는 무엇인가요?

- 지정 생성자에 의존하는 생성자로, 지정생성자보다 적은 파라미터로 보다 편리하게 생성하기 위한 생성자입니다.
- 초기화 과정을 좀 더 간편하게 하기 위한 생성자라고 할 수 있습니다.

### 19. AnyObject에 대해 설명하시오.

- 어떠한 클래스의 인스턴스도 다 담을 수 있는 타입이며 실제로 사용할 때에는 다운캐스팅을 해야할 필요가 있습니다.

#### 19-1. Any와 AnyObject의 차이는 뭔가요?

- Any는 어떠한 타입의 인스턴스를 모두 담을 수 있는 타입이고, AnyObject는 어떠한 클래스의 인스턴스도 담을 수 있다 라는 타입입니다. (구조체 XXXX)

### 20. Struct 가 무엇이고 어떻게 사용하는지 설명하시오.

- 구조체는 프로그래머가 데이터를 용도에 맞게 묶어 표현하고자 할 때 유용하게 사용됩니다.
- 구조체 안에 프로퍼티와 메서드를 선언하여 구조화된 데이터와 기능을 가질 수 있습니다.

### 21. Subscripts에 대해 설명하시오.

- class, struct, enum 타입 혹은 배열, 딕셔너리, set 등의 collection 타입에서 대괄호를 통해 속성이나 원소를 접근할 수 있는 문법

#### 21-1. String은 왜 subscript로 접근이 안되는지 설명하시오.
...
### 23. Delegate 패턴을 활용하는 경우를 예를 들어 설명하시오.
### 24. Singleton 패턴을 활용하는 경우를 예를 들어 설명하시오.

- 싱글톤 패턴은 객체의 인스턴스가 오직 하나만 생성되어 전체 모듈에서 하나의 인스턴스만 사용하는 패턴입니다. 
- 보통 NotificationCenter나 UserDefaults, UIScreen 등에서 사용하게 됩니다.

### 25. KVO 동작 방식에 대해 설명하시오.
### 26. Delegates와 Notification 방식의 차이점에 대해 설명하시오.
### 27. 멀티 쓰레드로 동작하는 앱을 작성하고 싶을 때 고려할 수 있는 방식들을 설명하시오.
### 28. MVC 구조에 대해 블록 그림을 그리고, 각 역할과 흐름을 설명하시오.
### 29. 프로토콜이란 무엇인지 설명하시오.
### 30. Protocol Oriented Programming과 Object Oriented Programming의 차이점을 설명하시오.
### 31. mutating 키워드에 대해 설명하시오.

- struct나 enum의 값 타입에서 자기 자신의 속성을 변경하고자 할 때 메소드 앞에 붙이는 키워드입니다.

### 31-1. 왜 class에서는 안붙여도 되고, struct나 enum에서 붙여야하나요?
...
### 33. defer란 무엇인지 설명하시오.
#### 33-1. defer가 호출되는 순서는 어떻게 되고, defer가 호출되지 않는 경우를 설명하시오.

### 34. 값타입/참조타입 차이? 그리고 어떤 상황에 각각을 사용하게 되는 것인지
